...
public class Database {
    ...
    public static MapWrapper<Integer, Vehicle> readBase() throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
            ...
            while (resultSet.next()) {
                ...
                vehicle.setCoordinates(new Coordinates(resultSet.getDouble("x"), resultSet.getFloat("y")));
                ...
                jsonList.add(updatedJsonString);
            }
    ...
    public static void updateBase(int id, String  name, java.util.Date creationDate, Double enginePower, float capacity, VehicleType type, FuelType fuelType, Coordinates coordinates) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ...
        try {
            ...
            String x = String.valueOf(coordinates.getX());
            String y = String.valueOf(coordinates.getY());
            ...
            String sql = String.format("UPDATE Vehicle " +
                            ...
                            "y = %s" +
                            "WHERE id = %s",
                    name, dateS, enginePowerS, capacityS, typeS, fuelTypeS,x,y, idS);
    ...
    public static void insertBase(String  name, java.util.Date creationDate, Double enginePower, float capacity, VehicleType type, FuelType fuelType, String userName, Coordinates coordinates) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ...
        try {
            ...
            String sql = String.format("INSERT INTO Vehicle (id, name, creationDate, enginePower, capacity, type, fuelType, user_name, x, y) VALUES (NEXTVAL('my_sequence'), '%s', '%s', %s, %s, '%s', '%s', '%s', %s, %s)",
                    name, dateS, enginePowerS, capacityS, typeS, fuelTypeS, userName, x, y);
